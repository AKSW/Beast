package org.aksw.beast.compare;
 ...
 * as integers. Therefore strings like a1, a10 a2 will be sorted as a1, a2, a10
 * rather than a1, a10, a2
 *
 * @author raven
 *
 */
...
public class StringPrettyComparator implements Comparator<Object> {
    ...
    public static String getPrefix(String s, boolean digitMode) {
        ...
        // while(Character.isDigit(s.charAt(i)) == digitMode && (i < s.length()
        // - 1))
        // ++i;
