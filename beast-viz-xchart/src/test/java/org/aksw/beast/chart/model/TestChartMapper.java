...
public class TestChartMapper {
	...
	public void testChartRendering() throws Exception {
        ...
        List<StastisticalBarChart> matches = JpaUtils.getResultList(em, StastisticalBarChart.class, (cb, cq) -> {
            Root<StastisticalBarChart> r = cq.from(StastisticalBarChart.class);
            cq.select(r);
        });
        
        
        for(StastisticalBarChart c : matches) {
